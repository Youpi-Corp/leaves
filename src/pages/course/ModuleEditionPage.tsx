...
const fetchModuleDetails = async (moduleId: string): Promise<ModuleDetails | null> => {
  const moduleId_num = parseInt(moduleId);
  const module = mockModules.find(m => m.id === moduleId_num);
  return module as ModuleDetails || null;
}
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-grow">
                        <div className="flex items-center">
                          ...
                          <h3 className="text-lg font-semibold text-bfbase-black">{lesson.title}</h3>
                        </div>
                        <p className="mt-2 text-bfbase-grey">{lesson.description}</p>
                      </div>
                      ...
                      <div className="text-right flex items-start">
                        ...
                        <div className="relative">
                          ...
                          >
                            <svg className="w-5 h-5 text-bfbase-grey" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
